...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-surface py-24">
      ...
      <Container size="sm" className="text-center">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-ink-heading mb-3">
          404 — Page Not Found
        </h1>

        <p className="text-base sm:text-lg text-ink-soft max-w-md mx-auto leading-relaxed mb-8">
