        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 max-w-xl lg:max-w-none mx-auto w-full">
          ...
          <div className="flex flex-col justify-between gap-6 lg:col-span-5">
            ...
            <div className="flex items-center justify-center w-full pt-2">
              <Link
                to="/media-press"
                className="inline-flex items-center justify-center gap-2.5 font-label text-xs font-bold uppercase tracking-[0.18em] text-gold-800 dark:text-gold-300 hover:text-gold-950 dark:hover:text-white px-6 py-3 rounded-full border border-gold-600/35 bg-surface-raised hover:bg-surface-sunken shadow-luxury hover:shadow-luxury-lg hover:border-gold-500/70 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 group"
              >
