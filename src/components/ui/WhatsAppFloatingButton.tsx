        ...
        <div className="mb-3 w-72 bg-emerald-950 border border-gold-500/40 rounded-2xl shadow-luxury-lg p-4 text-ivory-500 backdrop-blur-md animate-fade-in">
          <div className="flex items-start justify-between mb-2">
            ...
            <button
              ...
              className="text-ivory-700 hover:text-ivory-500 p-1 rounded-md cursor-pointer"
              aria-label="Close"
            >
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2 px-3 bg-emerald-600 hover:bg-emerald-500 text-ivory-500 text-xs font-semibold rounded-xl transition-colors shadow-sm cursor-pointer"
          >
