...
export const FeaturedMediaLogos: React.FC = () => {
  return (
    <div className="border-b border-ivory-800 bg-[#FAF6F0] py-6 sm:py-8">
      <Container>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 sm:gap-x-8 gap-y-3">
            {MEDIA_OUTLETS.map((outlet) => (
              ...
              >
                <span className="font-serif text-sm sm:text-base font-bold tracking-tight text-emerald-950 group-hover:text-gold-700 transition-colors">
                  {outlet.name}
                </span>
              </div>
            ))}
