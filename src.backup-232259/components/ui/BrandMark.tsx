      ...
      <div className="flex flex-col justify-center min-w-0">
        ...
        <div className="flex items-baseline min-w-0">
          <span
            ...
            className="font-cinzel font-bold uppercase tracking-[0.1em] xs:tracking-[0.14em] sm:tracking-[0.18em] text-emerald-950 leading-none truncate transition-colors duration-200 group-hover:text-gold-800 text-[clamp(0.78rem,2.4vw+0.35rem,1.16rem)]"
          >
            H.E. Zeenat Kureshi
          </span>
        </div>
        ...
        <div className="mt-0.5 xs:mt-1 hidden xs:flex items-center gap-1.5 min-w-0">
          ...
          <span
            ...
            className="font-label font-semibold uppercase tracking-[0.18em] sm:tracking-[0.22em] text-[#8A6920] leading-none truncate text-[0.58rem] sm:text-[0.66rem] lg:text-[0.7rem]"
          >
            {subtitle}
          </span>
        </div>
