...
const PageLoader = () => (
  <div className="min-h-[80vh] flex flex-col items-center justify-center bg-ivory-500 text-emerald-950">
    <div className="w-14 h-14 rounded-full border-2 border-emerald-900 border-t-gold-500 animate-spin" />
...
export const App: React.FC = () => {
  return (
    <HelmetProvider>
      <ScrollToTop />
      <div className="flex flex-col min-h-screen bg-ivory-500 font-sans text-charcoal-900 selection:bg-gold-500/30 selection:text-emerald-950">
        <Navbar />
